...
import { Letterboxd } from "./types/filmData";

export function LetterboxdData(username: string) {
    const LetterboxdUser = username //My Letterboxd username for test
